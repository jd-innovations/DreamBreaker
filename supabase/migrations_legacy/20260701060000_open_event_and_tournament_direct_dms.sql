-- =============================================================================
-- Fix direct-message RLS for visible event/tournament contact CTAs.
--
-- The app exposes:
-- - Community Play: "Message Organizer" to authenticated visitors.
-- - Tournament detail: "Message Director" to authenticated visitors.
--
-- Keep contextual play_event/tournament chats restricted to actual participants,
-- but allow direct one-to-one contact with the organizer/director shown on the
-- public detail page.
-- =============================================================================
...
comment on policy "conversations: participants insert" on public.conversations is
  'Direct: mutual Partner Finder like, tournament director<->registrant, play_event organizer<->claimed participant, anyone<->play_event organizer, or anyone<->visible tournament director. Contextual chats require event/tournament participation.';
