-- DreamBreaker PB - Fix personal match distribution RPC return shape
-- Forward-only patch for completed-session distribution. No PAR, claim links, AI, or weather logic.
