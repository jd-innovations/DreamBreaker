...
alter table public.par_game_processing
  ...
  add constraint par_game_processing_verification
    check (verification_level is null or verification_level in ('organizer_verified','fully_verified','participant_verified','estimated','disputed','excluded'));
alter table public.par_rating_events
  drop constraint if exists par_rating_events_verification,
  add constraint par_rating_events_verification
    check (verification_level in ('organizer_verified','fully_verified','participant_verified','estimated','disputed','excluded'));
