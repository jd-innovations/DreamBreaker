// Mock data for Dream Breaker PB

export const HERO_IMG = "https://images.unsplash.com/photo-1618551763300-dc7eb8ce3560?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NTYxODd8MHwxfHNlYXJjaHwxfHxwaWNrbGViYWxsJTIwYWN0aW9uJTIwcG9ydHJhaXR8ZW58MHx8fHwxNzgxMjYzMzI0fDA&ixlib=rb-4.1.0&q=85";

export const COURT_IMG = "https://images.unsplash.com/photo-1737477004595-e9b659bb44ca?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NTYxODd8MHwxfHNlYXJjaHw0fHxwaWNrbGViYWxsJTIwYWN0aW9uJTIwcG9ydHJhaXR8ZW58MHx8fHwxNzgxMjYzMzI0fDA&ixlib=rb-4.1.0&q=85";

export const PROFILE_IMAGES = {
  m1: "https://images.pexels.com/photos/11000101/pexels-photo-11000101.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
  m2: "https://images.unsplash.com/photo-1606335544053-c43609e6155d?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2ODh8MHwxfHNlYXJjaHwxfHxhdGhsZXRpYyUyMHBvcnRyYWl0fGVufDB8fHx8MTc4MTI2MzMyNHww&ixlib=rb-4.1.0&q=85",
  w1: "https://images.unsplash.com/photo-1723004714201-cf224222b897?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NTYxODd8MHwxfHNlYXJjaHwzfHxwaWNrbGViYWxsJTIwYWN0aW9uJTIwcG9ydHJhaXR8ZW58MHx8fHwxNzgxMjYzMzI0fDA&ixlib=rb-4.1.0&q=85",
...
export const tournaments = [
  {
    id: "t-001",
    name: "Sunset Slam Open",
    location: "Austin, TX",
    venue: "Zilker Park Courts",
    date: "Mar 14, 2026",
    dateISO: "2026-03-14",
    format: "Doubles · Round Robin + Single Elim",
    level: "3.5 – 4.5",
    prize: "$5,200",
    entryFee: 65,
    holdFee: 10,
    ...
    status: "Open",
    img: COURT_IMG,
    director: "Marco Velasquez",
  },
  {
    id: "t-002",
    name: "Pacific Coast Classic",
    location: "San Diego, CA",
    venue: "Mission Bay Sports Complex",
    date: "Apr 02, 2026",
    dateISO: "2026-04-02",
    format: "Mixed Doubles · Double Elim",
    level: "4.0 – 5.0",
    prize: "$12,000",
    entryFee: 95,
    holdFee: 15,
    ...
    filled: 36,
    status: "Filling Fast",
    img: "https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=1200&q=80",
    director: "Jenna Kowalski",
  },
  {
    id: "t-003",
    name: "Mountain States Showdown",
    location: "Denver, CO",
    venue: "Cherry Creek Pavilion",
    date: "Apr 19, 2026",
    dateISO: "2026-04-19",
    format: "Singles · Single Elim",
    level: "3.0 – 4.0",
    prize: "$3,400",
    entryFee: 50,
    holdFee: 10,
    ...
    director: "Reid Tanaka",
  },
  {
    id: "t-004",
    name: "Iron Paddle Championship",
    location: "Miami, FL",
    venue: "South Beach Athletic Club",
    date: "May 08, 2026",
    dateISO: "2026-05-08",
    ...
    director: "Aisha Brennan",
  },
  {
    id: "t-005",
    name: "Lone Star Junior Cup",
    location: "Dallas, TX",
    venue: "DFW Pickle Arena",
    date: "May 22, 2026",
    dateISO: "2026-05-22",
    format: "Juniors · Single Elim",
    level: "U18",
    prize: "$1,800",
    entryFee: 30,
    holdFee: 5,
  ...
  },
  {
    ...
    venue: "Twin Cities Indoor Pickle",
    date: "Jun 06, 2026",
    dateISO: "2026-06-06",
    format: "Doubles · Double Elim",
    level: "3.5 – 4.5",
    prize: "$6,750",
    entryFee: 75,
    holdFee: 10,
    ...
    filled: 18,
    status: "Open",
    img: "https://images.unsplash.com/photo-1623298317883-6b70254edf31?w=1200&q=80",
    director: "Jenna Kowalski",
  },
];
...
export const matchPartners = [
  {
    ...
    img: PROFILE_IMAGES.w1,
    badges: ["Mixed Doubles", "DUPR 4.2", "Tournaments: 14"],
  },
  {
    id: "p-102",
    name: "Devon Mackay",
  ...
  },
  {
    ...
    bio: "Calm under pressure, never miss a return of serve. Open to mixed and women's doubles.",
    img: PROFILE_IMAGES.w2,
    badges: ["Mixed", "Women's Doubles", "DUPR 3.9"],
  },
  {
    id: "p-104",
    ...
    location: "Austin, TX",
    distance: "5 mi",
    style: "Bangers + transition",
    availability: "Flexible",
    bio: "Hard hitter looking to climb 5.0. Need a controlled partner who can dink all day.",
    img: PROFILE_IMAGES.m2,
    badges: ["Doubles", "DUPR 4.8", "Tournaments: 27"],
  },
  {
    id: "p-105",
    name: "Avery Lin",
    ...
    bio: "Just moved from the Bay Area. Looking for a strong mixed partner for the Sunset Slam.",
    img: PROFILE_IMAGES.w3,
    badges: ["Mixed", "DUPR 4.0", "New to TX"],
  },
];
...
export const bracketMatches = {
  ...
  f: [
    { id: "f1", p1: "Morgan / Rojas", p2: "Brennan / Cho", s1: "—", s2: "—", winner: 0 },
  ],
};
