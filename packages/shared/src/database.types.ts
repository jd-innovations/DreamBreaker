  ...
  public: {
    Tables: {
      ...
      wallet_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "wallet_items_granted_by_fkey"
            columns: ["granted_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "wallet_items_revoked_by_fkey"
            columns: ["revoked_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      mark_personal_guest_share_initiated: {
        Args: { p_channel?: string; p_guest_share_id: string }
        Returns: {
          created_at: string
          created_by: string
          guest_player_id: string
      ...
      payment_is_fulfilled: { Args: { p_payment_id: string }; Returns: boolean }
      ...
      prune_push_tickets: { Args: never; Returns: number }
