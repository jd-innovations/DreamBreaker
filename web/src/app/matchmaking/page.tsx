              ...
              <div className="fixed bottom-5 left-0 right-0 px-6 lg:hidden z-40">
                <div className="flex items-center gap-3 max-w-sm mx-auto bg-background/80 backdrop-blur-md border border-border rounded-full px-4 py-3 shadow-lg">
                  ...
                  {lastPassed && (
                    <button
                      onClick={undo}
                      className="h-10 w-10 rounded-full bg-gradient-to-br from-yellow-400/50 to-amber-500/50 text-white flex items-center justify-center shadow-lg shadow-yellow-400/20 hover:brightness-110 transition-all active:scale-95 flex-shrink-0"
                  ...
                  <button
                    ...
                    className="h-12 w-12 rounded-full bg-gradient-to-br from-violet-600/50 to-purple-500/50 text-white flex items-center justify-center shadow-lg shadow-purple-500/20 hover:brightness-110 transition-all hover:scale-105 active:scale-95 flex-shrink-0"
                    title="Super Connect"
                  >
                    <Plug size={20} weight="fill" />
                  </button>
