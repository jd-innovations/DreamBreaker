                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between flex-1 p-6 lg:p-8 overflow-y-auto">
                      ...
                      <div className="hidden lg:flex items-center justify-center gap-3 mt-5">
                        ...
                        {lastPassed && (
                          <button onClick={undo} className="h-10 w-10 rounded-full border-2 border-yellow-400 text-yellow-400 flex items-center justify-center hover:bg-yellow-400/10 transition-all active:scale-95 flex-shrink-0" title="Undo last pass">
              ...
              <div className="fixed bottom-5 left-0 right-0 px-6 lg:hidden z-40">
                <div className="flex items-center justify-center gap-3 mx-auto bg-background/80 backdrop-blur-md border border-border rounded-full px-4 py-3 shadow-lg w-fit">
                  ...
                  {lastPassed && (
                    <button
                      onClick={undo}
                      className="h-10 w-10 rounded-full border-2 border-yellow-400 text-yellow-400 flex items-center justify-center hover:bg-yellow-400/10 transition-all active:scale-95 flex-shrink-0"
