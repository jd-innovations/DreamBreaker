...
178 files migrated, listed from the tree with the sha of the commit
...
| | Occurrences | Files |
| --- | ---: | ---: |
| Files importing `@shared/tokens` (migrated) | — | **178 of 218** (82%) |
| Raw `fontSize: N` remaining | 685 | 122 |
| `borderRadius: radius.*` from `@/theme` remaining | 97 | 19 |
