...
34 files migrated, listed from the tree with the sha of the commit
...
| | Occurrences | Files |
| --- | ---: | ---: |
| Files importing `@shared/tokens` (migrated) | — | **34 of 218** (16%) |
| Raw `fontSize: N` remaining | 2153 | 191 |
| `borderRadius: radius.*` from `@/theme` remaining | 438 | 105 |
