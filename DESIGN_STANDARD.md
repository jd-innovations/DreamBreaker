...
| `components/PrimaryButton.tsx` — shared, 31 screens | `pending` | radius 14 → `shape.cta` 10; label 16/700 → `actionLarge` 16/800. |
| `components/SecondaryButton.tsx` — shared, 16 screens | `pending` | Same two changes. |
