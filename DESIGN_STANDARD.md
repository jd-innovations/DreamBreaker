...
| `app/booking/choose-time.tsx` — Choose Time | `pending` | First screen needing **no new roles** — all 22 text styles mapped to the existing set. Three radii 14 → 10. Price 15/800 → `rowValue` 14/800, matching facility detail. |
