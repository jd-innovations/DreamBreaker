...
const s = StyleSheet.create({
  ...
  title:        { color: L.navy, fontSize: 30, fontWeight: '900', letterSpacing: 0.2, marginBottom: 10 },
  ...
  depositText: { color: L.success, fontSize: 13, fontWeight: '700' },

  card: {
    borderWidth: 1, borderColor: L.border, borderRadius: radius.card,
    backgroundColor: L.bg, marginBottom: 16, overflow: 'hidden',
  },
  cardTitle: { color: L.navy, fontSize: 16, fontWeight: '800', paddingHorizontal: 16, paddingVertical: 14 },
  divider:   { height: StyleSheet.hairlineWidth, backgroundColor: L.border },
  summaryRow: {
    flexDirection: 'row', alignItems: 'flex-start', gap: 10,
    paddingHorizontal: 16, paddingVertical: 13,
  },
  summaryLabel: { color: L.textSub, fontSize: 11, fontWeight: '600', marginBottom: 2 },
  summaryValue: { color: L.navy,    fontSize: 14, fontWeight: '700' },
  ...
  completeBtnLabel: { color: L.navy, fontSize: 14, fontWeight: '800' },
  completeBtnSub:   { color: L.textSub, fontSize: 12, marginTop: 1 },
});
