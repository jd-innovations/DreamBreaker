      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={s.body} keyboardShouldPersistTaps="handled">
        ...
        {STEPS[step] === 'Location' && (
          <LocationStep
            ...
            fulfillment={draft.fulfillment}
            onFulfillmentChange={(f) => setDraft((d) => ({ ...d, fulfillment: f }))}
...
function LocationStep({
  ...
  facility, onPickFacility, onClearFacility, fulfillment, onFulfillmentChange,
}: {
  ...
  return (
    <View>
      <Text style={s.stepHint}>
        ...
        You can agree the exact meeting point in chat.
      </Text>

      <PickupCourtPicker facility={facility} onPick={onPickFacility} onClear={onClearFacility} />
      ...
      <View style={s.chipRow}>
        {FULFILLMENT_OPTIONS.map((opt) => (
          <TouchableOpacity
            ...
            onPress={() => onFulfillmentChange(opt.value)}
            activeOpacity={0.8}
          >
...
const s = StyleSheet.create({
  ...
  stepHint: { color: L.textMuted, fontSize: text.caption.size, fontWeight: '500', marginBottom: 14, lineHeight: 18 },
  ...
  photoTile: { width: 100, height: 100, borderRadius: shape.panel, overflow: 'hidden' },
  photoImg: { width: '100%', height: '100%' },
  photoRemove: { position: 'absolute', top: 4, right: 4 },
  photoAdd: { width: 100, height: 100, borderRadius: shape.panel, borderWidth: 1.5, borderColor: L.border, borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center', gap: 4 },
  photoAddText: { color: L.navy, fontSize: text.caption.size, fontWeight: '500' },
  ...
  chip: {
    borderWidth: 1, borderColor: L.border, borderRadius: 20,
  ...
  titlePreviewValue: { color: L.navy, fontSize: text.titleSm.size, fontWeight: '800' },

  optionRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 16, paddingHorizontal: 16, borderRadius: shape.cta, borderWidth: 1.5, borderColor: L.border, marginBottom: 10 },
  ...
  amountInput: { flex: 1, fontSize: text.cardTitle.size, fontWeight: '800', color: L.text, paddingVertical: 14 },
  ...
  improveBtn: { marginTop: 14, alignSelf: 'flex-start', paddingHorizontal: 16, paddingVertical: 10, borderRadius: shape.pill, borderWidth: 1.5, borderColor: L.gold },
  improveBtnText: { color: L.navy, fontSize: text.action.size, fontWeight: '800' },
  warningRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, marginTop: 12, padding: 12, backgroundColor: '#FEE2E2', borderRadius: shape.cta },
  warningText: { flex: 1, color: L.danger, fontSize: text.caption.size, fontWeight: '500', lineHeight: 16 },
  promptText: { color: L.textMuted, fontSize: text.caption.size, fontWeight: '500', marginTop: 4 },

  title: { color: L.text, fontSize: text.cardTitle.size, fontWeight: '800', marginBottom: 8 },
  ...
  previewPhoto: { width: 220, height: 220, borderRadius: shape.card, marginRight: 10 },

  limitTitle: { color: L.navy, fontSize: text.titleSm.size, fontWeight: '800' },
  limitBody: { color: L.textMuted, fontSize: text.body.size, fontWeight: '500', textAlign: 'center', lineHeight: 20 },
});
