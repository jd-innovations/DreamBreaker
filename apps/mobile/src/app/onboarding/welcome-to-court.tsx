...
const s = StyleSheet.create({
  ...
  welcome: { color: L.navy, fontSize: 30, lineHeight: 34, fontWeight: '900' },
  name: { color: L.gold, fontSize: 30, lineHeight: 36, fontWeight: '900', marginBottom: spacing.md },
  introSub: { width: 230, color: '#6B7280', fontSize: 15, lineHeight: 21, fontWeight: '600' },
  sectionIntro: { marginBottom: spacing.sm },
  eyebrow: { color: '#6B7280', fontSize: 11, fontWeight: '900', letterSpacing: 0.5 },
  conditionsCard: { minHeight: 82, borderRadius: 24, backgroundColor: L.white, borderWidth: 1, borderColor: '#EBEEF3', flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.md, shadowColor: '#000', shadowOpacity: 0.07, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 2, marginBottom: spacing.md },
  ...
  conditionGood: { color: L.success, fontSize: 11, fontWeight: '900' },
  ...
  conditionValue: { color: L.navy, fontSize: 12, fontWeight: '900', textAlign: 'center' },
  ...
  bestTimeText: { color: '#4B5563', fontSize: 12, fontWeight: '700' },
  bestTimeGold: { color: L.gold, fontWeight: '900' },
  courtCard: { borderRadius: 22, backgroundColor: L.white, overflow: 'hidden', borderWidth: 1, borderColor: '#E7EAF0', shadowColor: '#000', shadowOpacity: 0.12, shadowRadius: 18, shadowOffset: { width: 0, height: 10 }, elevation: 4, marginBottom: spacing.xl },
  ...
  liveBadge: { position: 'absolute', top: spacing.md, left: spacing.md, flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: L.success, borderRadius: 999, paddingHorizontal: spacing.sm, paddingVertical: 5 },
  liveDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: L.white },
  liveText: { color: L.white, fontSize: 10, fontWeight: '900' },
  saveBtn: { position: 'absolute', top: spacing.md, right: spacing.md, width: 38, height: 42, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.72)', alignItems: 'center', justifyContent: 'center' },
  courtTitleBlock: { position: 'absolute', left: spacing.lg, right: spacing.lg, top: 142 },
  courtTitle: { color: L.white, fontSize: 24, lineHeight: 28, fontWeight: '900', textShadowColor: 'rgba(0,0,0,0.28)', textShadowRadius: 8, textShadowOffset: { width: 0, height: 2 } },
  homeCourtRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  homeCourtText: { color: L.white, fontSize: 12, fontWeight: '800' },
  ...
  homeStatValue: { color: L.navy, fontSize: 15, fontWeight: '900' },
  homeStatLabel: { color: '#6B7280', fontSize: 9, fontWeight: '700', textAlign: 'center' },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: spacing.sm },
  sectionTitle: { color: L.navy, fontSize: 13, fontWeight: '900' },
  sectionAction: { color: L.gold, fontSize: 12, fontWeight: '900' },
  gameCard: { minHeight: 92, borderRadius: 20, backgroundColor: '#F8FCFA', borderWidth: 1, borderColor: '#DDEAE6', flexDirection: 'row', alignItems: 'center', padding: spacing.sm, marginBottom: spacing.xl },
  gamePhoto: { width: 70, height: 70, borderRadius: 14, marginRight: spacing.md },
  ...
  gameTitle: { color: L.navy, fontSize: 14, fontWeight: '900' },
  gameMeta: { color: '#4B5563', fontSize: 12, fontWeight: '700', marginBottom: spacing.sm },
  ...
  recommendCard: { borderRadius: 20, borderWidth: 1.5, borderColor: '#E0D0FA', backgroundColor: '#FBF7FF', padding: spacing.md, marginBottom: spacing.xl },
  ...
  recommendLabel: { color: '#7A49CB', fontSize: 11, fontWeight: '900' },
  recommendBodyRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.md },
  recommendCopy: { flex: 1 },
  recommendText: { color: L.navy, fontSize: 13, lineHeight: 19, fontWeight: '800' },
  matchPotential: { color: '#8B5CF6', fontSize: 12, fontWeight: '800', marginTop: spacing.sm },
  matchStack: { flexDirection: 'row', alignItems: 'center' },
  findGameCta: { minHeight: 60, borderRadius: 18, backgroundColor: L.gold, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xl, shadowColor: L.gold, shadowOpacity: 0.36, shadowRadius: 16, shadowOffset: { width: 0, height: 8 }, elevation: 5 },
  findGameText: { color: L.white, fontSize: 16, fontWeight: '900' },
