...
type MenuItem = { icon: string; label: string; danger?: boolean };
...
function useContextMenu() {
  ...
  return { visible, open, close, opacity, scale };
}

function ContextMenu({
  items, top, right, opacity, scale, caretRight = 13, onItemPress,
}: {
  items: MenuItem[]; top: number; right: number;
