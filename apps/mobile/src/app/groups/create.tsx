...
const ph = StyleSheet.create({
  ...
  uploadSub: { color: L.textSub, fontSize: text.caption.size, fontWeight: '500', textAlign: 'center' },
  label: { color: L.textSub, fontSize: text.caption.size, fontWeight: '500', paddingHorizontal: 14, paddingBottom: 10 },
});
...
const gd = StyleSheet.create({
  ...
  charCount: { color: L.textSub, fontSize: text.caption.size, fontWeight: '500', textAlign: 'right', marginTop: 4 },
